 ...
 */
public class Bezier extends Image {
     ...
     * @param b
     */
    public Bezier(int width_p, int height_p, Color color) {

        super(width_p, height_p, color);
    }
    /*--------------------------------------------------------------------------
     ...
     */
    public void steps(int[] P0, int[] P1, int[] P2, int[] P3, double step, Color color)
    {
